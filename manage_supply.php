...
<html lang="en">
	...
	<body>
		...
		<!-- <button type="button" class=" btn-sm rounded-pill btn-outline-info" data-toggle="modal" data-target="#success_modal"><span><i class="fas fa-cart-plus"></i>  Add Supply</span></button></a> -->
    <div class="card-body">
    <div id="table" class="">
           ...
           <div class="modal-content">  
                <div class="modal-header">	
                    <h4 class="modal-title text-center"></h4><button type="button" class="close" data-dismiss="modal">&times;</button>  
                		...
                		<div class="modal-body"> 
						<h4 class="modal-title text-center">Succesfully inserted!</h4>
				</div>
                <div class="modal-footer">
