		...
		<div class="container-fluid custom-0">
			...
			<div class= "custom-1 custom-2">
				<ul class="nav li list-unstyled d-flex justify-content-center custom-3">
					...
					<li class="nav-item custom-3">
						<a href="purchase-request_staff.php"><span ><i class="fas fa-list-alt"></i> Purchase Request</span></a>
					</li>
					<li class="nav-item custom-3">
						<a href="#"><span style="color: #FFD700"><i class="far fa-list-alt"></i> Purchase Orders</span></a>
					</li>
				</ul>
			</div>
		</div>
